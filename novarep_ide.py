...
Label(ventana, text="Ruta de directorio CSV:").grid(row=3, column=0, padx=5, pady=5, sticky="w")
entry_csv = Entry(ventana, width=50)
entry_csv.grid(row=4, column=0, padx=5, pady=5)
Button(ventana, text="Seleccionar Carpeta", command=lambda: seleccionar_ruta_async(entry_csv, False)).grid(row=4, column=1, padx=5, pady=5)
