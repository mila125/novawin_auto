...
def work_with_squares(t,rectangle_width,rectangle_height,distancia_hasta_el_borde_x,distancia_hasta_el_borde_y,old_width,old_heigth,h,distancia_hasta_el_borde_oldl):
    ...
    if(rectangle_height > distancia_hasta_el_borde_y or rectangle_width > 600) :
       ...
       if(rama_izquierda >= 0 or rama_derecha >= 0):
           h-=2
           rama_derecha=draw_diagonal_branches_rigth(t, numeros_derecha[h]-lados_rectangulos[h-2], numeros_derecha[h+1], (lados_rectangulos[h-2]/2)-(lados_rectangulos[h]/2), cantidad/2,old_width,old_heigth)
           rama_izquierda=draw_diagonal_branches_left(t, numeros_derecha[h]-lados_rectangulos[h-2], numeros_derecha[h+1],(lados_rectangulos[h-2]/2)-(lados_rectangulos[h]/2), cantidad/2,old_width,old_heigth)
           ramas_diagonales = np.append(rama_izquierda, rama_derecha) 
